...
@Bot.on_message(filters.command('start') & filters.private & subscribed & subscribed4 & subscribed2 & subscribed3)
...
async def not_joined(client: Client, message: Message): 
    buttons = [
    [InlineKeyboardButton(text="SUBSCRIBE Channel", url="https://youtube.com/@cryptowithemperor?si=YmQdeQOiEX-dBu4X")],
    [
