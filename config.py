...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7017158354:AAELoDoyIW2sY5lk1dcACGvQIqwViPDuS5k")
...
# Req Fsub
FORCE_SUB_CHANNEL4 = int(os.environ.get("FORCE_SUB_CHANNEL4", "-1002218732634"))
